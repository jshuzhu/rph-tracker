      ...
      <div className="max-w-5xl mx-auto space-y-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-xl">
          ...
          <div className="flex flex-wrap gap-2 w-full md:w-auto items-center">
            <Link href="/reviewer/dashboard" className="bg-slate-800 hover:bg-slate-700 text-white px-4 py-2 text-xs font-bold rounded-xl transition whitespace-nowrap flex items-center justify-center">Kembali</Link>
