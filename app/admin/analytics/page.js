    ...
    <div className="flex-grow bg-transparent text-slate-100 py-8 px-4 sm:px-6">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-bold text-slate-400 uppercase">Laporan Sekolah</span>
        </div>

        {/* Title */}
        <div className="bg-slate-900 text-white p-5 rounded-3xl shadow-md flex justify-between items-center gap-3">
          <div>
            <h1 className="text-base font-extrabold tracking-tight">Analisis Prestasi Sekolah</h1>
            <p className="text-[10px] text-purple-200 mt-0.5 font-medium">Metrik pematuhan dan integritas RPH sekolah.</p>
          </div>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-3xl p-5 shadow-sm space-y-3">
              <h3 className="text-xs font-extrabold text-rose-500">Defisit Penghantaran RPH</h3>
              {analytics.deficitList.length === 0 ? (
                <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 p-3.5 rounded-2xl text-[11px] font-bold">
                  ...
                  <span>Tahniah! Semua guru telah selesai menghantar laporan RPH bagi minggu {analyticsWeek}.</span>
                </div>
              ) : (
            ...
            {/* Rejection Heatmap */}
            <div className="bg-slate-900 border border-slate-700 rounded-3xl p-5 shadow-sm space-y-3">
              <h3 className="text-xs font-extrabold text-slate-100">Kekerapan Pembetulan RPH Guru</h3>
              {analytics.rejectionHeatmap.length === 0 ? (
                <p className="text-[10px] text-slate-400 font-bold">Tiada sebarang laporan pembetulan dikesan setakat ini.</p>
              ) : (
